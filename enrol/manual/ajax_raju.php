...
$courseurl = new moodle_url('/course/view.php', array('id' => $course->id)); //Course Home URL
$body = "You have been enrolled to course"." <a href=".$courseurl.">".$course->fullname."</a><br/><br/>"."Please login to start your course."."<br/><br/>"."Thanks,"."<br/> Admin";
if ($course->id == SITEID) {
