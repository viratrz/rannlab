...
$CFG->dbname    = 'MoodleLms2';     // database name, eg moodle
$CFG->dbuser    = 'yatharthd';   // your database username
$CFG->dbpass    = 'Yath@6849';   // your database password
...
$CFG->dataroot  = '/var/www/newmoodledata';
