...
$string['allowcoursethemes'] = 'Allow unit themes';
...
$string['backup_shortname'] = 'Use unit name in backup filename';
$string['backup_shortnamehelp'] = 'Use the unit name as part of the backup filename.';
...
$string['blockprotect_help'] = 'If you lock a particular type of block, then no-one will be able to add or delete instances. (You can, of unit, unlock again if you need to edit instances.)
...
$string['calendartype_desc'] = 'Choose a default calendar type for the whole site. This setting can be overridden in the unit settings or by users in their personal profile.';
...
$string['configallowcategorythemes'] = 'If you enable this, then themes can be set at the category level. This will affect all child categories and units unless they have specifically set their own theme. WARNING: Enabling category themes may affect performance.';
...
$string['configallowcoursethemes'] = 'If enabled, then courses will be allowed to set their own themes.  Unit themes override all other theme choices (site, user, category, cohort or URL-defined themes).';
...
$string['configallowuserthemes'] = 'If you enable this, then users will be allowed to set their own themes.  User themes override site themes (but not unit themes)';
...
$string['configautologinguests'] = 'Should visitors be logged in as guests automatically when entering units with guest access?';
...
$string['configcoursegraceperiodafter'] = 'Classify past units as in progress for these many days after the unit end date.';
$string['configcoursegraceperiodbefore'] = 'Classify future units as in progress for these many days prior to the unit start date.';
$string['configcourseoverviewfilesext'] = 'A comma-separated list of allowed unit image file extensions.';
$string['configcourseoverviewfileslimit'] = 'The maximum number of files that can be displayed next to the unit summary on the list of units page. The first image file added is used as the course image in the course overview on users\' Dashboards; any additional files are displayed on the list of courses page only.';
$string['configcourserequestnotify'] = 'Type username of user to be notified when new unit requested.';
$string['configcourserequestnotify2'] = 'Users who will be notified when a unit is requested. Only users who can approve course requests are listed here.';
$string['configcoursesperpage'] = 'Enter the number of units to be displayed per page in a unit listing.';
$string['configcourseswithsummarieslimit'] = 'The maximum number of units to display in a unit listing including summaries before falling back to a simpler listing.';
...
$string['configdefaultrequestcategory'] = 'Units requested by users with the capability to request new courses in the system context will be placed in this category unless users are able to select a different category.';
$string['configdefaultrequestedcategory'] = 'Default category to put units that were requested into, if they\'re approved.';
$string['configdefaultuserroleid'] = 'All logged in users will be given the capabilities of the role you specify here, at the site level, in ADDITION to any other roles they may have been given.  The default is the Authenticated user role.  Note that this will not conflict with other roles they have unless you prohibit capabilities, it just ensures that all users have capabilities that are not assignable at the unit level (eg post blog entries, manage own calendar, etc).';
...
$string['configenablecourserequests'] = 'If enabled, users with the capability to request new units (moodle/course:request) will have the option to request a unit. This capability is not allowed for any of the default roles. It may be applied in the system or category context.';
...
$string['configenablestats'] = 'If you choose \'yes\' here, Moodle\'s cronjob will process the logs and gather some statistics.  Depending on the amount of traffic on your site, this can take awhile. If you enable this, you will be able to see some interesting graphs and statistics about each of your units, or on a sitewide basis.';
...
$string['configfilternavigationwithsystemcontext'] = 'Normal use of the filtering is tied to the context in which it is used (e.g. unit context), but for the site navigation, explicitly making everything filter with site context can yield performance improvements when using "content and headings" filtering.';
...
$string['configforcelogin'] = 'Normally, the site home and the course listings (but not units) can be read by people without logging in to the site. If you want to force people to log in before they do ANYTHING on the site, then you should enable this setting.';
...
$string['configfrontpagecourselimit'] = 'Maximum number of units';
$string['configfrontpagecourselimithelp'] = 'Maximum number of units to be displayed on the site home in unit listings.';
...
$string['configsectionrequestedcourse'] = 'Unit requests';
...
$string['course_customfield'] = 'Unit custom fields';
...
$string['coursecolorsettings'] = 'Unit card colours';
$string['coursecontact'] = 'Unit contacts';
...
$string['coursemgmt'] = 'Manage units and categories';
$string['courseoverview'] = 'Unit overview';
$string['courserequestnotify'] = 'Unit request notification';
$string['courserequestnotifyemail'] = 'User {$a->user} requested a new course at {$a->link}';
$string['courserequests'] = 'Unit requests';
$string['courserequestspending'] = 'Pending unit requests';
$string['courses'] = 'Units';
$string['coursesperpage'] = 'Units per page';
$string['courseswithsummarieslimit'] = 'Units with summaries limit';
...
$string['defaultrequestcategory'] = 'Default category for unit requests';
...
$string['downloadcoursecontentallowed'] = 'Download unit content feature available';
...
$string['restorecourse'] = 'Restore unit';
...
$string['sort_fullname'] = 'Unit Name';
$string['sort_idnumber'] = 'Unit Code';
