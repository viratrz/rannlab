...
$string['activities_help'] = 'Activities, such as forums, quizzes and wikis, enable interactive content to be added to the unit.';
...
$string['addcreator'] = 'Add unit creator';
$string['adddots'] = 'Add...';
$string['added'] = 'Added {$a}';
$string['addedtogroup'] = 'Added to group "{$a}"';
$string['addedtogroupnot'] = 'Not added to group "{$a}"';
$string['addedtogroupnotenrolled'] = 'Not added to group "{$a}", because not enrolled in unit';
...
$string['addnewcourse'] = 'Add a new unit';
...
$string['adminhelpassigncreators'] = 'Unit creators can create new units';
$string['adminhelpassignsiteroles'] = 'Apply defined site roles to specific users';
$string['adminhelpassignstudents'] = 'Go into a unit and add students from the admin menu';
...
$string['adminhelpcourses'] = 'Define units and categories and assign people to them, edit pending units';
...
$string['administratordescription'] = 'Administrators can usually do anything on the site, in all units.';
...
$string['allowstealthmodules_help'] = 'If enabled, activities can be made available but not shown in visible sections of the unit page. If so, links to stealth activities must be provided from elsewhere, such as from a page resource. Stealth activities are still listed in the gradebook and other reports.';
...
$string['areyousuretorestorethisinfo'] = 'Later in this process you will have a choice of adding this backup to an existing unit or creating a completely new unit.';
...
$string['availablecourses'] = 'Available units';
$string['back'] = 'Back';
$string['backto'] = 'Back to {$a}';
$string['backtocourselisting'] = 'Back to unit listing';
...
$string['backupadhocpending'] = 'units backup ad hoc task pending';
$string['backupcancelled'] = 'Backup cancelled';
$string['backupcoursefileshelp'] = 'If enabled then unit files will be included in automated backups';
...
$string['backupfailed'] = 'Some of your units weren\'t saved!!';
...
$string['backupincludemoduleshelp'] = 'Choose whether you want to include unit modules, with or without user data, in automated backups';
...
$string['backupsitefileshelp'] = 'If enabled then site files used in units will be included in automated backups';
...
$string['bulkmovecoursessuccess'] = 'Successfully moved {$a->courses} units into {$a->category}';
$string['bycourseorder'] = 'By units order';
$string['byname'] = 'by {$a}';
...
$string['categories'] = 'Unit categories';
$string['categoriesandcourses'] = 'Unit categories and units';
$string['category'] = 'Category';
$string['categoryadded'] = 'The category \'{$a}\' was added';
$string['categorybulkaction'] = 'Bulk actions for selected categories';
$string['categorycontents'] = 'Subcategories and units';
...
$string['idnumbercoursecategory_help'] = 'The ID number of a unit category  is only used when matching the category against external systems and is not displayed anywhere on the site. If the category has an official code name it may be entered, otherwise the field can be left blank.';
...
$string['closecourseindex'] = 'Close unit index';
...
$string['confirmcoursemove'] = 'Are you sure you want to move this unit ({$a->course}) into this category ({$a->category})?';
$string['considereddigitalminor'] = 'You are too young to create an account on this site.';
$string['content'] = 'Content';
$string['contentexport_aboutthiscourse'] = 'Unit summary';
...
$string['continuetocourse'] = 'Click here to enter your unit';
...
$string['copycourse'] = 'Copy unit';
$string['copyingcoursefiles'] = 'Copying unit files';
$string['copyingsitefiles'] = 'Copying site files used in unit';
...
$string['course'] = 'Unit';
$string['courseheader'] = 'Unit menu';
$string['courseadministration'] = 'Unit administration';
$string['courseapprovedemail'] = 'Your requested unit, {$a->name}, has been approved and you have been made a {$a->teacher}.  To access your new unit, go to {$a->url}';
$string['courseapprovedemail2'] = 'Your requested unit, {$a->name}, has been approved.  To access your new unit, go to {$a->url}';
$string['courseapprovedfailed'] = 'Failed to save the unit as approved!';
$string['courseapprovedsubject'] = 'Your unit has been approved!';
$string['courseavailable'] = 'This unit is available to students';
$string['courseavailablenot'] = 'This unit is not available to students';
$string['coursebackup'] = 'Unit backup';
$string['coursebulkaction'] = 'Bulk actions for selected units';
$string['coursecategories'] = 'Units categories';
$string['coursecategory'] = 'Unit category';
$string['coursecategory_help'] = 'This setting determines the category in which the unit will appear in the list of units.';
$string['coursecategorydeleted'] = 'Deleted unit category {$a}';
$string['coursecatmanagement'] = 'Unit and category management';
$string['coursecompletion'] = 'Unit completion';
$string['coursecompletions'] = 'Unit completions';
$string['coursecreators'] = 'Unit creator';
$string['coursecreatorsdescription'] = 'Unit creators can create new units.';
$string['coursedetails'] = 'Unit details';
$string['coursedisplay'] = 'Unit layout';
$string['coursedisplay_help'] = 'This setting determines whether the whole unit is displayed on one page or split over several pages.';
$string['coursedisplay_single'] = 'Show all sections on one page';
$string['coursedisplay_multi'] = 'Show one section per page';
$string['coursedeleted'] = 'Deleted units {$a}';
$string['courseextendednamedisplay'] = '{$a->shortname} {$a->fullname}';
$string['coursefiles'] = 'Legacy unit files';
$string['coursefilesedit'] = 'Edit legacy unit files';
$string['coursefileswarning'] = 'Unit files are deprecated';
$string['coursefileswarning_help'] = 'Unit files are deprecated since Moodle 2.0, please use external repositories instead as much as possible.';
$string['courseformatdata'] = 'Unit format data';
$string['courseformats'] = 'Unit formats';
$string['courseformatoptions'] = 'Formatting options for {$a}';
$string['courseformatudpate'] = 'Update format';
$string['courseprofiles'] = 'Unit profiles';
$string['coursegrades'] = 'Unit grades';
$string['coursehelpcategory'] = 'Position the unit on the unit listing and may make it easier for students to find it.';
$string['coursehelpforce'] = 'Force the unit group mode to every activity in the unit.';
$string['coursehelpformat'] = 'The unit main page will be displayed in this format.';
$string['coursehelphiddensections'] = 'How the hidden sections in the unit are displayed to students.';
$string['coursehelpmaximumupload'] = 'Define the largest size of file that can be uploaded in this unit, limited by the site-wide setting.';
$string['coursehelpnewsitemsnumber'] = 'Number of recent announcements appearing in the latest announcements block on the unit page. If set to zero, the announcements forum will not be created.';
$string['coursehelpnumberweeks'] = 'Number of sections in the unit (applies to certain unit formats only).';
$string['coursehelpshowgrades'] = 'Enable the display of the gradebook. It does not prevent grades from being displayed within the individual activities.';
$string['coursehidden'] = 'This unit is currently unavailable to students';
$string['courseoverviewfiles'] = 'Unit image';
$string['courseoverviewfilesext'] = 'Unit image file extensions';
$string['courseoverviewfileslimit'] = 'Unit image files limit';
$string['courseoverviewfiles_help'] = 'The unit image is displayed in the unit overview on the Dashboard. Additional accepted file types and more than one file may be enabled by a site administrator. If so, these files will be displayed next to the unit summary on the list of units page.';
$string['courseinfo'] = 'Unit info';
$string['coursenotaccessible'] = 'This unit does not allow public access';
$string['courselegacyfiles'] = 'Legacy unit files';
$string['courselegacyfiles_help'] = 'The unit files area provides some backward compatibility with Moodle 1.9 and earlier.  All files in this area are always accessible to all participants in the unit (whether you link to them or not) and there is no way to know where any of these files are being used in Moodle.
...
$string['courselegacyfiles_link'] = 'unitfiles2';
$string['courselegacyfilesofcourse'] = 'Legacy unit files: {$a}';
$string['courseoverview'] = 'Unit overview';
$string['courseoverviewgraph'] = 'Unit overview graph';
...
$string['coursereject'] = 'Reject a unit request';
$string['courserejected'] = 'Unit has been rejected and the requester has been notified.';
$string['courserejectemail'] = 'Sorry, but the unit you requested has been rejected. Here is the reason provided:

{$a}';
$string['courserejectreason'] = 'Outline your reasons for rejecting this unit<br />(this will be emailed to the requester)';
$string['courserejectsubject'] = 'Your unit has been rejected';
$string['coursereport'] = 'Unit report';
$string['coursereports'] = 'Unit reports';
$string['courserequest'] = 'Unit request';
$string['courserequestdetails'] = 'Details of the unit you are requesting';
$string['courserequestfailed'] = 'For some reason, your unit request could not be saved';
$string['courserequestintro'] = 'Use this form to request a unit to be created for you.<br />Try and fill in as much information as you can to allow<br />the administrators to understand your reasons for wanting this course.';
$string['courserequestreason'] = 'Reasons for wanting this unit';
$string['courserequestsuccess'] = 'Your unit request has been saved successfully. You will be sent an email to inform you whether your request was approved.';
$string['courserequestsupport'] = 'Supporting information to help the administrator evaluate this request';
$string['courserequestwarning'] = 'The user requesting this unit will be automatically enrolled and assigned the role of {$a}.';
$string['courserestore'] = 'Unit restore';
$string['coursereuse'] = 'Unit reuse';
$string['courses'] = 'Unit';
$string['coursesectionsummaries'] = 'Unit section summaries';
$string['coursesectiontitle'] = 'Unit: {$a->course}, {$a->sectionname}: {$a->sectiontitle}';
$string['coursesettings'] = 'Unit default settings';
$string['coursesmovedout'] = 'Units moved out from {$a}';
$string['coursespending'] = 'Units pending approval';
$string['coursesearch'] = 'Search units';
...
$string['coursestart'] = 'Unit start';
$string['coursesummary'] = 'Unit summary';
$string['coursesummary_help'] = 'The unit summary is displayed in the list of units. A unit search searches unit summary text in addition to unit names.';
$string['coursetitle'] = 'Unit: {$a->course}';
$string['courseupdates'] = 'Unit updates';
$string['coursevisibility'] = 'Unit visibility';
$string['coursevisibility_help'] = 'This setting determines whether the unit appears in the list of courses and whether students can access it. If set to Hide, then access is restricted to users with the capability to view hidden courses (such as teachers).';
...
$string['createnewcourse'] = 'Create a new Unit';
...
$string['creatingcoursemodules'] = 'Creating unit modules';
$string['creatingcourseroles'] = 'Creating unit level role assignments and overrides';
...
$string['creatingnewcourse'] = 'Creating new unit';
...
$string['currentcourse'] = 'Current unit';
$string['currentcourseadding'] = 'Current unit, adding data to it';
$string['currentcoursedeleting'] = 'Current unit, deleting it first';
...
$string['defaultcoursestudentdescription'] = 'Students generally have fewer privileges within a unit.';
$string['defaultcoursestudents'] = 'Students';
$string['defaultcoursesummary'] = 'Write a concise and interesting paragraph here that explains what this unit is about';
$string['defaultcourseteacher'] = 'Teacher';
$string['defaultcourseteacherdescription'] = 'Teachers can do anything within a unit, including changing the activities and grading students.';
...
$string['deletecategorycheck2'] = 'If you delete this category, you need to choose what to do with the units and subcategories it contains.';
$string['deletecommentbyon'] = 'Delete comment posted by {$a->user} on {$a->time}';
$string['deletecompletely'] = 'Delete completely';
$string['deletecourse'] = 'Delete a unit';
$string['deletecoursecheck'] = 'Are you absolutely sure you want to completely delete this unit and all the data it contains?';
...
$string['deletingexistingcoursedata'] = 'Deleting existing unit data';
...
$string['dndcourse'] = 'You can drag and drop this unit to alter its sorting or to move it to another category.';
...
$string['dndworkingfiletextlink'] = 'Drag and drop files, text or links onto unit sections to upload them';
$string['dndworkingfilelink'] = 'Drag and drop files or links onto unit sections to upload them';
$string['dndworkingfiletext'] = 'Drag and drop files or text onto unit sections to upload them';
$string['dndworkingfile'] = 'Drag and drop files onto unit sections to upload them';
$string['dndworkingtextlink'] = 'Drag and drop text or links onto unit sections to upload them';
$string['dndworkingtext'] = 'Drag and drop text onto unit sections to upload it';
$string['dndworkinglink'] = 'Drag and drop links onto unit sections to upload them';
$string['documentation'] = 'Moodle documentation';
$string['dontsortcategories'] = 'Don\'t sort categories';
$string['dontsortcourses'] = 'Don\'t sort units';
$string['down'] = 'Down';
...
$string['editcoursesettings'] = 'Edit unit settings';
...
$string['emaildisplaycourse'] = 'Allow only other unit participants to see my email address';
$string['emaildisplaycoursemembersonly'] = '(Visible to other unit participants)';
...
$string['emptycmids'] = 'Empty unit module IDs';
$string['emptydragdropregion'] = 'empty region';
$string['emptysectionids'] = 'Empty section IDs';
$string['enable'] = 'Enable';
$string['encryptedcode'] = 'Encrypted code';
$string['enddate'] = 'Unit end date';
$string['enddate_help'] = 'The unit end date determines whether a unit is listed as past in the unit overview. The unit end date may also be used by custom reports. Note that users can still enter the unit after the end date; in other words the date does not restrict access.';
$string['english'] = 'English';
$string['enrolmentmethods'] = 'Enrolment methods';
$string['entercourse'] = 'Click to enter this unit';
...
$string['eventcoursebackupcreated'] = 'Unit backup created';
...
$string['eventcoursecontentdeleted'] = 'Unit content deleted';
$string['eventcoursecreated'] = 'Unit created';
$string['eventcoursedeleted'] = 'Unit deleted';
$string['eventcourseinformationviewed'] = 'Unit summary viewed';
$string['eventcoursemodulecreated'] = 'Unit module created';
$string['eventcoursemoduledeleted'] = 'Unit module deleted';
$string['eventcoursemoduleupdated'] = 'Unit module updated';
$string['eventcoursemoduleviewed'] = 'Unit module viewed';
$string['eventcoursessearched'] = 'Unit searched';
$string['eventcourseresetended'] = 'Unit reset ended';
$string['eventcourseresetstarted'] = 'Unit reset started';
$string['eventcourserestored'] = 'Unit restored';
$string['eventcourseupdated'] = 'Unit updated';
$string['eventcoursesectioncreated'] = 'Unit section created';
$string['eventcoursesectiondeleted'] = 'Unit section deleted';
$string['eventcoursesectionupdated'] = 'Unit section updated';
$string['eventcoursemoduleinstancelistviewed'] = 'Unit module instance list viewed';
$string['eventcourseuserreportviewed'] = 'Unit user report viewed';
$string['eventcourseviewed'] = 'Unit viewed';
...
$string['eventmycoursesviewed'] = 'My units viewed';
...
$string['existingcourse'] = 'Existing unit';
$string['existingcourseadding'] = 'Existing unit, adding data to it';
$string['existingcoursedeleting'] = 'Existing unit, deleting it first';
$string['existingcreators'] = 'Existing unit creators';
...
$string['findmorecourses'] = 'Find more units...';
$string['first'] = 'First';
...
$string['format_help'] = 'The unit format determines the layout of the unit page.

* Single activity format - For displaying a single activity or resource (such as a Quiz or SCORM package) on the course page
* Social format - A forum is displayed on the unit page
* Topics format - The unit page is organised into topic sections
* Weekly format - The unit page is organised into weekly sections, with the first week starting on the unit start date';
...
$string['frontpagecourselist'] = 'List of units';
$string['frontpagecoursesearch'] = 'Unit search box';
$string['frontpageenrolledcourselist'] = 'Enrolled units';
$string['frontpagedescription'] = 'Site home summary';
$string['frontpagedescriptionhelp'] = 'This summary can be displayed on the site home using the unit/site summary block.';
...
$string['fulllistofcourses'] = 'All units';
$string['fullname'] = 'Full name'; /* @deprecated - Use fullnamecourse or fullnameuser or some own context specific string. */
$string['fullnamecourse'] = 'Unit full name';
$string['fullnamecourse_help'] = 'The full name of the unit is displayed at the top of each page in the unit and in the list of units.';
...
$string['guestuserinfo'] = 'This user is a special user that allows read-only access to some units.';
$string['help'] = 'Help';
...
$string['hiddenoncoursepage'] = 'Available but not shown on unit page';
$string['hiddensections'] = 'Hidden sections';
$string['hiddensections_help'] = 'Whether hidden sections are displayed to students as not available (perhaps for a unit in weekly format to indicate holidays) or are completely hidden.';
...
$string['hideoncoursepage'] = 'Make available but not shown on unit page';
...
$string['checkingcourse'] = 'Checking units';
...
$string['childcoursenotfound'] = 'Child unit not found!';
$string['childcourses'] = 'Child units';
$string['choose'] = 'Choose';
$string['choosecourse'] = 'Choose a units';
...
$string['courseduration'] = 'Unit duration';
$string['courseduration_desc'] = 'The unit duration is used to calculate the default unit end date. The unit end date is used for determining whether a unit should be included in a user\'s list of units.  It may also be used by custom reports. Users can still enter the unit after the end date.';
$string['courseenddateenabled'] = 'Unit end date enabled by default';
$string['courseenddateenabled_desc'] = 'This setting determines if the unit end date will be enabled by default for new units and set to the date calculated from the unit duration.';
...
$string['idnumbercourse'] = 'Unit Code';
$string['idnumbercourse_help'] = 'The ID number of a unit is only used when matching the unit against external systems and is not displayed anywhere on the site. If the unit has an official code name it may be entered, otherwise the field can be left blank.';
...
$string['importdata'] = 'Import unit data';
$string['importdataexported'] = 'Exported data from \'from\' unit successfully.<br /> Continue to import into your \'to\' unit.';
$string['importdatafinished'] = 'Import complete! Continue to your unit';
$string['importdatafrom'] = 'Find a unit to import data from:';
$string['inactive'] = 'Inactive';
$string['include'] = 'Include';
$string['includeallusers'] = 'Include all users';
$string['includecoursefiles'] = 'Include unit files';
$string['includecourseusers'] = 'Include unit users';
...
$string['includesitefiles'] = 'Include site files used in this unit';
$string['includeuserfiles'] = 'Include user files';
$string['increasesections'] = 'Increase the number of sections';
$string['indicator:accessesafterend'] = 'Unit accessed after end date';
$string['indicator:accessesafterend_help'] = 'This indicator reflects if the student accessed the unit after the unit end date.';
$string['indicator:accessesbeforestart'] = 'Unit accessed before start date';
$string['indicator:accessesbeforestart_help'] = 'This indicator reflects if the student accessed the unit before the unit start date.';
$string['indicator:activitiesdue'] = 'Activities due';
$string['indicator:activitiesdue_help'] = 'The user has activities due.';
$string['indicator:anycourseaccess'] = 'Any unit access';
$string['indicator:anycourseaccess_help'] = 'This indicator reflects access to any unit that the user is enrolled in.';
...
$string['indicator:anywriteincourse'] = 'Any write action in the unit';
$string['indicator:anywriteincourse_help'] = 'This indicator represents any write (submit) action taken by the student in any unit activity.';
...
$string['indicator:completionenabled_help'] = 'This indicator represents that completion tracking has been enabled for this unit.';
$string['indicator:nostudent'] = 'Student enrolments';
$string['indicator:nostudent_help'] = 'This indicator reflects the availability of students in the unit.';
$string['indicator:noteacher'] = 'Teacher availability';
$string['indicator:noteacher_help'] = 'This indicator reflects the availability of teachers in the unit.';
$string['indicator:potentialcognitive'] = 'Unit potential cognitive depth';
$string['indicator:potentialcognitive_help'] = 'This indicator is based on the potential cognitive depth that could be reached by a student participating in unit activities.';
$string['indicator:potentialcognitivedef'] = 'Unit potential cognitive depth';
$string['indicator:potentialcognitivedef_help'] = 'The degree to which the unit offers "deep" cognitive engagement, e.g. submission of work for feedback, the opportunity to review work by others, and the opportunity to revise and resubmit work.';
$string['indicator:potentialcognitivedef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:potentialsocial'] = 'Unit potential social breadth';
$string['indicator:potentialsocial_help'] = 'This indicator is based on the potential social breadth that could be reached by the student participating in unit activities.';
$string['indicator:potentialsocialdef'] = 'Unit potential social breadth';
$string['indicator:potentialsocialdef_help'] = 'The degree to which the unit offers "broad" social engagement, interacting with other participants and with the community of practice beyond the class.';
...
$string['lastcourseaccess'] = 'Last access to unit';
...
$string['listofcourses'] = 'List of units';
...
$string['maincoursepage'] = 'Main unit page';
...
$string['managecombined'] = 'Manage unit categories and units';
$string['managecategories'] = 'Manage unit categories';
...
$string['managecourses'] = 'Manage units';
...
$string['maximumupload_help'] = 'This setting determines the largest size of file that can be uploaded to the unit, limited by the site-wide setting set by an administrator. Activity modules also include a maximum upload size setting for further restricting the file size.';
$string['maxnumberweeks'] = 'Maximum number of sections';
$string['maxnumberweeks_desc'] = 'The maximum value in the number of sections drop-down menu (applies to certain unit formats only).';
$string['maxnumcoursesincombo'] = 'Browse <a href="{$a->link}">{$a->numberofcourses} units</a>.';
...
$string['memberincourse'] = 'People in the unit';
...
$string['messageprovider:coursecompleted'] = 'Unit completed';
$string['messageprovider:coursecontentupdated'] = 'Unit content changes';
$string['messageprovider:courserequestapproved'] = 'Unit creation request approval notification';
$string['messageprovider:courserequested'] = 'Unit creation request notification';
$string['messageprovider:courserequestrejected'] = 'Unit creation request rejection notification';
...
$string['movecourseto'] = 'Move unit to:';
...
$string['moveselectedcoursesto'] = 'Move selected units to...';
...
$string['newsitemsnumber_help'] = 'The announcements forum is a special forum which is created automatically in the unit, has forced subscription set by default, and only users with appropriate permissions (by default teachers) can post in it.

This setting determines how many recent announcements appear in the latest announcements block.

If an announcements forum is not required in the unit, this setting should be set to zero.';
...
$string['nocourses'] = 'No units';
$string['nocoursesfound'] = 'No units were found with the words \'{$a}\'';
$string['nocoursestarttime'] = 'The units does not have a start date.';
$string['nocoursesyet'] = 'No units in this category';
...
$string['nofilesyet'] = 'No files have been uploaded to your unit yet';
...
$string['noimagesyet'] = 'No images have been uploaded to your unit yet';
$string['nologsfound'] = 'No logs have been found';
$string['nomatchingusers'] = 'No users match \'{$a}\'';
$string['nomorecourses'] = 'No more matching units could be found';
$string['nomoreidnumber'] = 'Not using an idnumber to avoid collisions';
$string['none'] = 'None';
$string['noneditingteacher'] = 'Non-editing teacher';
$string['noneditingteacherdescription'] = 'Non-editing teachers can teach in units and grade students, but may not alter activities.';
$string['nonstandard'] = 'Non-standard';
$string['nopendingcourses'] = 'There are no units pending approval';
$string['nopotentialadmins'] = 'No potential admins';
$string['nopotentialcreators'] = 'No potential units creators';
...
$string['nosite'] = 'Could not find site-level unit';
$string['nostudentsfound'] = 'No {$a} found';
$string['nostudentsingroup'] = 'There are no students in this group yet';
$string['nostudentsyet'] = 'There are no students enrolled in this unit.';
$string['nosuchemail'] = 'No such email address';
$string['notavailable'] = 'Not available';
$string['notavailablecourse'] = '{$a} is not available';
$string['noteachersyet'] = 'No teachers in this unit yet';
$string['noteachingupcomingcourses'] = 'Upcoming units have no teachers or students';
$string['notenrolled'] = '{$a} is not enrolled in this unit.';
$string['notenrolledprofile'] = 'This profile is not available because this user is not enrolled in this unit.';
...
$string['noteuserschangednonetocourse'] = '<strong>Note:</strong> Unit users need to be restored when restoring user data (in activities, files or messages). This setting has been changed for you.';
...
$string['novalidcourses'] = 'No valid units to be shown';
$string['now'] = 'now';
$string['numattempts'] = '{$a} failed login attempt(s)';
$string['numberofcourses'] = 'Number of units';
...
$string['opendrawerindex'] = 'Open unit index';
...
$string['parentcoursenotfound'] = 'Parent unit not found!';
...
$string['potentialcreators'] = 'Potential unit creators';
...
$string['privacy:metadata:log:course'] = 'unit';
...
$string['profilenotshown'] = 'This profile description will not be shown until this person is enrolled in at least one unit.';
...
$string['relativedatesmode_help'] = 'Display unit or activity dates relative to the user\'s start date in the unit.
...
$string['relativedatesmode_warning'] = '<strong>Warning:</strong> Relative dates mode cannot be changed once the unit has been created.';
$string['reload'] = 'Reload';
$string['remoteappuser'] = 'Remote {$a} User';
$string['remove'] = 'Remove';
$string['removeadmin'] = 'Remove admin';
$string['removecreator'] = 'Remove unit creator';
...
$string['requestcourse'] = 'Request a unit';
$string['requestedby'] = 'Requested by';
$string['requestedcourses'] = 'Requested units';
$string['requestreason'] = 'Reason for unit request';
$string['requests'] = 'Requests';
$string['required'] = 'Required';
$string['requirespayment'] = 'This unit requires payment for access';
$string['resendemail'] = 'Resend email';
$string['reset'] = 'Reset';
$string['resetcomponent'] = 'Component';
$string['resetcourse'] = 'Reset unit';
$string['resetinfo'] = 'This page allows you to empty a unit of user data, while retaining the activities and other settings.  Please be warned that by choosing items below and submitting this page you will delete your chosen user data from this unit forever!';
...
$string['resortcourses'] = 'Sort units';
...
$string['resources_help'] = 'Resource types enable almost any kind of web content to be inserted into the units.';
...
$string['restorecoursenow'] = 'Restore this unit now!';
...
$string['rolerenaming_help'] = 'This setting allows the displayed names for roles used in the unit to be changed. Only the displayed name is changed - role permissions are not affected.  New role names will appear on the unit participants page and elsewhere within the unit. If the renamed role is one that the administrator has selected as a unit manager role, then the new role name will also appear as part of the unit listings.';
$string['roles'] = 'Roles';
$string['rss'] = 'RSS';
...
$string['savechangesandreturntocourse'] = 'Save and return to unit';
...
$string['scalestandard_help'] = 'A standard scale is available site-wide, for all units.';
$string['scalestandard_link'] = 'grade/scale';
$string['scalestip'] = 'To create custom scales, use the \'Scales...\' link in your unit administration menu.';
$string['scalestip2'] = 'To create custom scales, click the Grades link in the unit administration menu, then choose Edit, Scales.';
...
$string['searchcourses'] = 'Search units';
...
$string['selectacourse'] = 'Select a unit';
$string['selectacoursesite'] = 'Select a unit or site';
...
$string['selectcoursesortby'] = 'Select how you would like to sort unit';
...
$string['shortnamecollisionwarning'] = '[*] = This shortname is already in use by a unit and will need to be changed upon approval';
$string['shortnamecourse'] = 'Unit short name';
$string['shortnamecourse_help'] = 'The short name of the unit is displayed in the navigation and is used in the subject line of unit email messages.';
$string['shortnametaken'] = 'Short name is already used for another unit ({$a})';
...
$string['showallcourses'] = 'Show all units';
$string['showallusers'] = 'Show all users';
$string['showblockcourse'] = 'Show list of units containing block';
...
$string['showdescription'] = 'Display description on unit page';
$string['showdescription_help'] = 'If enabled, the description above will be displayed on the unit page just below the link to the activity or resource.';
$string['showgrades'] = 'Show gradebook to students';
$string['showgrades_help'] = 'Many activities allow grades to be set. This setting determines whether a student can view a list of all their grades in the unit.';
$string['showingacourses'] = 'Showing all {$a} units';
$string['showingxofycourses'] = 'Showing units {$a->start} to {$a->end} of {$a->total} units';
$string['showlistofcourses'] = 'Show list of units';
$string['showmodulecourse'] = 'Show list of units containing activity';
$string['showoncoursepage'] = 'Show on unit page';
...
$string['sitefilesused'] = 'Site files used in this unit';
...
$string['skiptocourselisting'] = 'Skip to the unit listings';
$string['skiptocoursedetails'] = 'Skip to the detailed unit information';
$string['socialheadline'] = 'Social forum - latest topics';
$string['someallowguest'] = 'Some units may allow guest access';
...
$string['starpending'] = '([*] = unit pending approval)';
$string['startdate'] = 'Unit start date';
$string['startdate_help'] = 'This setting determines the start of the first week for a unit in weekly format. It also determines the earliest date that logs of unit activities are available for. If the unit is reset and the unit start date changed, all dates in the unit will be moved in relation to the new start date.';
...
$string['statsnodata'] = 'There is no available data for that combination of unit and time period.';
$string['statsnodatauser'] = 'There is no available data for that combination of unit, user and time period.';
...
$string['statsreport11'] = 'Most active units';
$string['statsreport12'] = 'Most active units (weighted)';
$string['statsreport13'] = 'Most participatory units (enrolments)';
$string['statsreport14'] = 'Most participatory units (posts/views)';
...
$string['statsreport9'] = 'Logins (site unit)';
...
$string['studentnotallowed'] = 'Sorry, but you can not enter this unit as \'{$a}\'';
...
$string['summary_help'] = 'The idea of a summary is a short text to prepare students for the activities within the topic or week. The text is shown on the unit page under the section name.';
...
$string['switchroleto_help'] = 'Choose a role to get an idea of how someone with that role will see this unit.
...
$string['timesplitting:deciles_help'] = 'This analysis interval divides the unit into tenths (10 equal parts), with each prediction being based on the data of only the most recent previous tenth.';
$string['timesplitting:decilesaccum'] = 'All previous tenths';
$string['timesplitting:decilesaccum_help'] = 'This analysis interval divides the unit into tenths (10 equal parts), with each prediction being based on the accumulated data of all previous tenths.';
...
$string['timesplitting:quarters_help'] = 'This analysis interval divides the unit into quarters (4 equal parts), with each prediction being based on the data of only the most recent previous quarter.';
$string['timesplitting:quartersaccum'] = 'All previous quarters';
$string['timesplitting:quartersaccum_help'] = 'This analysis interval divides the unit into quarters (4 equal parts), with each prediction being based on the accumulated data of all previous quarters.';
$string['timesplitting:singlerange'] = 'From start to end';
$string['timesplitting:singlerange_help'] = 'This analysis interval considers the entire unit as a single span.';
...
$string['timesplitting:tenpercentafterstart_help'] = 'This analysis interval generates a prediction after the 10% of the unit is completed.';
$string['thanks'] = 'Thanks';
$string['theme'] = 'Theme';
$string['themes'] = 'Themes';
$string['themesaved'] = 'New theme saved';
$string['thereareno'] = 'There are no {$a} in this unit';
$string['therearecourses'] = 'There are {$a} units';
$string['thiscategory'] = 'This category';
$string['thiscategorycontains'] = 'This category contains';
$string['time'] = 'Time';
$string['timecreated'] = 'Time created';
$string['timecreatedcourse'] = 'Unit time created';
...
$string['unexistingcmid'] = 'Unit module ID not found';
$string['unexistingsectionid'] = 'Unit section ID not found';
...
$string['updatethiscourse'] = 'Update this unit';
...
$string['usingexistingcourse'] = 'Using existing unit';
$string['validatehtml'] = 'Validate HTML';
$string['valuealreadyused'] = 'This value has already been used.';
$string['version'] = 'Version';
$string['view'] = 'View';
$string['viewing'] = 'Viewing:';
$string['viewallcourses'] = 'View all units';
$string['viewallcoursescategories'] = 'View all units and categories';
...
$string['visible_help'] = 'This setting determines whether the unit appears in the list of units. Apart from teachers and administrators, users are not allowed to enter the unit.';
...
$string['writingcoursedata'] = 'Writing unit data';
...
$string['youneedtoenrol'] = 'To perform that action you need to enrol in this unit.';
...
$string['msnid'] = 'MSN ID';
$string['coursepreferences'] = 'Unit preferences';
