<?php
    ...
    <tr style="height: 20px; margin-bottom: 25px;">
        <th scope="col" colspan="6" class="p-0"><h3 class="text-center text-uppercase bg-dark text-white m-0 py-2" style="font-weight: bolder">RTO Unit Pending Allocation Summary</h3></th>
    </tr>
