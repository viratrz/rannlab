...
if (isset($del_id)) 
{
    ...
    if ($status) 
    {
        redirect("custom_admin_list.php", "User Deleted Successfully", null, \core\output\notification::NOTIFY_INFO);
    }
    else
    {
        redirect("custom_admin_list.php", "Something Wrong User Not Delete", null, \core\output\notification::NOTIFY_WARNING);
    }
}
?>
