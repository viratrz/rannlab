...
<head>
   <meta charset="utf-8">
   <title>Create New Sandpit Area </title>
      ...
      <div class="row">
         <div class="col-md-12 px-0">
            <div class="heading mb-3 heading-row">
               <h5 style="color: red;" class="px-2 mb-0" ><b style="color: white;">Create Sandpit Admin</b></h5>
            </div>
         </div>
         <div class="col-md-12 m-auto box-shadow bg-white p-4">
            <form action="" id="addnewAdmin" method="get">
               ...
               <div class="form-group row">
                  ...
                  <div class="d-flex">
                     <a href="##" class="button d-block  text-center" onclick="addAdmin();">Create New Sandpit Area</a> &nbsp;
...
document.getElementById('username').defaultValue = 'Sandpit RTO';
document.getElementById('firstname').defaultValue = 'Sandpit';
document.getElementById('lastname').defaultValue = 'RTO';
document.getElementById('password').defaultValue = 'Rto@123';
document.getElementById('confirmpassword').defaultValue = 'Rto@123';
...
document.getElementById('createButton').addEventListener('click', function() {
  document.getElementById('package').value = '0 USD package been used for this Sandpit Area';
});
