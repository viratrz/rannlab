...
function local_vxg_menus_extend_navigation(global_navigation $nav) {
    ...
    // if (isset($config->removecreateusernodeadmin) && $config->removecreateusernodeadmin == true && is_siteadmin()) {
    //     if ($PAGE->context->get_course_context(false) == true && $COURSE->id != SITEID) {
    //         if ($createusernode = $nav->find('Create user', global_navigation::TYPE_SETTING)) {
    //             $createusernode->remove();
    //         }
    //     }
    // }
