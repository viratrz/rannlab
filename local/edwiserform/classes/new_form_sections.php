...
class new_form_sections {
    ...
    /**
     * On true builder panel will be visible
     * @var boolean
     */
    private $builderactive;

    /**
     * Form builder svg icon
     * @var string
     */
    ...
    /**
     * Assign form section data to section_data and return.
     *
     * @return stdClass Section data
     */
    public function get_form_section_data() {
        ...
        $this->section_data->countries = $this->get_countries();
     ...
     * @param html $countries Countries list
     */
    ...
    /**
     * Getter page url list
     * @return array Page url list
     */
    ...
    /**
     * Setter for page url list
     * @param array $listpageurl Page url list
     */
