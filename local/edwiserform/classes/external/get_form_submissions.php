...
trait get_form_submissions {
    ...
    public static function get_form_submissions_parameters() {
        return new external_function_parameters(
            array(
                ...
                'sort'     => new external_value(PARAM_ALPHA, 'Sorting order of date column')
            )
        );
    }
     ...
     */
    public static function get_form_submissions($formid, $search, $start = 0, $length = 0, $sort = 'asc') {
        global $PAGE;
        ...
        list($rows, $errors) = $listformdata->get_submissions_list($limit, $search, $sort);
