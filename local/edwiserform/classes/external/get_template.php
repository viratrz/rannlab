...
use local_edwiserform_license_controller;
...
trait get_template {
    ...
    public static function get_template($name) {
        ...
        $plugin = $controller->get_plugin($name);
        ...
        if ($plugin->is_pro_plugin() && $lcontroller->getDataFromDb() != 'available') {
            $responce['msg'] = 'license-inactive';
            return $responce;
        }
