...
class block_cocoon_course_grid_8_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        // Hover text
        $mform->addElement('text', 'config_hover_text', get_string('config_hover_text', 'block_cocoon_course_grid_8'));
        $mform->setDefault('config_hover_text', 'Preview Course');
        $mform->setType('config_hover_text', PARAM_RAW);

        // Hover accent
        $mform->addElement('text', 'config_hover_accent', get_string('config_hover_accent', 'block_cocoon_course_grid_8'));
        ...
        // $mform->addElement('html', '<a class="btn btn-secondary mt20 mb30 " href="'.$CFG->wwwroot.'/blocks/cocoon_course_grid_8/cocoon_course_grid_8.php">Select Featured Courses</a>');
        ...
        $mform->setDefault('config_color_btn', '#fe4a55');
        ...
        $mform->setDefault('config_color_btn_hover', '#fe4a55');
