...
class block_cocoon_course_grid_4_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        // Hover text
        $mform->addElement('text', 'config_hover_text', get_string('config_hover_text', 'block_cocoon_course_grid_4'));
        $mform->setDefault('config_hover_text', 'Preview Course');
        $mform->setType('config_hover_text', PARAM_RAW);

        // Hover accent
        $mform->addElement('text', 'config_hover_accent', get_string('config_hover_accent', 'block_cocoon_course_grid_4'));
        ...
        // $mform->addElement('html', '<a class="btn btn-secondary mt20 mb30 " href="'.$CFG->wwwroot.'/blocks/cocoon_course_grid_4/cocoon_course_grid_4.php">Select Featured Courses</a>');
        ...
        $mform->setDefault('config_color_button', 'rgb(255, 0, 95)');
        ...
        $mform->addElement('text', 'config_color_course_subtitle', get_string('config_color_course_subtitle', 'theme_edumy'), array('class'=>'ccn_spectrum_class'));
        $mform->setDefault('config_color_course_subtitle', 'rgb(255, 234, 193)');
        $mform->setType('config_color_course_subtitle', PARAM_TEXT);
        ...
        $mform->setDefault('config_color_course_price', 'rgb(255, 0, 95)');
