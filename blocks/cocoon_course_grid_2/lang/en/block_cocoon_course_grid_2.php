...
$string['cocoon_course_grid_2:addinstance'] = 'Add a [Cocoon] Featured Courses (Large) block';
$string['cocoon_course_grid_2:myaddinstance'] = 'Add a [Cocoon] Featured Courses (Large) to my moodle';
$string['pluginname'] = '[Cocoon] Featured Courses Large';
...
$string['cocoon_course_grid_2'] = '[Cocoon] Featured Courses (Large)';
