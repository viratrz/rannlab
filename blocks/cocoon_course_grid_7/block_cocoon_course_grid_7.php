...
class block_cocoon_course_grid_7 extends block_base {
    ...
    public function init() {
        $this->title = get_string('pluginname', 'block_cocoon_course_grid_7');
    }
    ...
    function specialization() {
        ...
        if (empty($this->config)) {
          ...
          $this->config->color_course_price = '#ffffff';
          $this->config->color_course_enrol_btn = '#79b530';
          $this->config->color_btn = '#23ad96';
          $this->config->color_btn_hover = '#23ad96';
    ...
    public function get_content() {
        ...
        if(!empty($this->config->color_btn)){$this->content->color_btn = $this->config->color_btn;} else {$this->content->color_btn = '#23ad96';}
        if(!empty($this->config->color_btn_hover)){$this->content->color_btn_hover = $this->config->color_btn_hover;} else {$this->content->color_btn_hover = '#23ad96';}
        ...
        $this->content->text .= '
        <section id="our-top-courses" class="'.$ccnClassMasonry_cont.' our-courses ccn-courses-grid-block ccn-courses-grid-block-7" data-ccn-c="color_bg" data-ccn-co="bg" style="background-color: '.$this->content->color_bg.';">
          <div class="container">
            <div class="row">
            ...
            <div class="'.$col_class.' cat-'.$course->category.'">
              ...
              $this->content->text .='
                  ...
                  if($ccnBlockShowPrice){
                    $this->content->text .= '<div class="course_price text-center" data-ccn="course_price" data-ccn-co="content" data-ccn-c="color_course_price" style="color: '.$this->content->color_course_price.';">'.$ccnCourse->price.'</div>';
                  }
                  $this->content->text .='
									</div>
                </div>';
...
';
    ...
    //               FROM {block_cocoon_course_grid_7} fc
    //               JOIN {course} c
    //                 ON (c.id = fc.courseid)
    //           ORDER BY sortorder';
    ...
    //     global $DB;
    //     return $DB->delete_records('block_cocoon_course_grid_7', array('courseid' => $courseid));
    // }
}
