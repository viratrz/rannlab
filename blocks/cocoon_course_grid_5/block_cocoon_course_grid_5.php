...
class block_cocoon_course_grid_5 extends block_base {
    ...
    public function get_content() {
        ...
        $this->content->text .= '
        <section id="our-top-courses" class="'.$ccnClassMasonry_cont.' our-courses ccn-courses-grid-block ccn-courses-grid-block-5" data-ccn-c="color_bg" data-ccn-co="bg" style="background-color: '.$this->content->color_bg.';">
          <div class="container">
            <div class="row">
        ...
        foreach ($courses as $course) {
          if ($DB->record_exists('course', array('id' => $course->id))) {
            ...
            <div class="'.$col_class.' cat-'.$course->category.'">
							...
							<div data-ccn-c="color_course_card" data-ccn-co="bg" style="background-color: '.$this->content->color_course_card.';" class="top_courses home13 '.$topCoursesClass.'">';
								if($ccnBlockShowImg){
                  $this->content->text .='
              ...
              $this->content->text .='
                  ...
                  if($ccnBlockShowPrice){
                    $this->content->text .= '<div class="tc_price text-thm8 mb15" data-ccn="course_price" data-ccn-co="content" data-ccn-c="color_course_price" style="color: '.$this->content->color_course_price.';">'.$ccnCourse->price.'</div>';
                  }
