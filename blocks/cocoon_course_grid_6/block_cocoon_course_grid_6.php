...
class block_cocoon_course_grid_6 extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_cocoon_course_grid_6');
    }
    ...
    public function get_content() {
        ...
        if(!empty($this->config->color_bg)){$this->content->color_bg = $this->config->color_bg;} else {$this->content->color_bg = '#f5f6fd';}
        ...
        $this->content->text .= '
        <section id="our-top-courses" class="'.$ccnClassMasonry_cont.' our-courses ccn-courses-grid-block ccn-courses-grid-block-6" data-ccn-c="color_bg" data-ccn-co="bg" style="background-color: '.$this->content->color_bg.';">
          <div class="container">
            <div class="row">
      ...
      if(!empty($this->config->courses)){
        ...
        if($total_courses < 2) {
          $col_class = 'col-12 col-lg-12 col-xl-12';
        } else {
          $col_class = 'col-12 col-lg-6 col-xl-6';
        }
...
';
    ...
    //               FROM {block_cocoon_course_grid_6} fc
    //               JOIN {course} c
    //                 ON (c.id = fc.courseid)
    //           ORDER BY sortorder';
    ...
    //     global $DB;
    //     return $DB->delete_records('block_cocoon_course_grid_6', array('courseid' => $courseid));
    // }
}
