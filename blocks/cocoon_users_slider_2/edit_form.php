...
class block_cocoon_users_slider_2_edit_form extends block_edit_form {
    ...
    /**
     * Extends the configuration form for block_cocoon_users_slider_2.
     */
    protected function specific_definition($mform)
    {
        ...
        $mform->addElement('autocomplete', 'config_users', get_string('cocoon_users_slider_2_users', 'block_cocoon_users_slider_2'), $usernames, [
        	'multiple' => true,
        ...
        $mform->setDefault('config_color_item_title', '#1b2032');
        ...
        $mform->setDefault('config_color_item_body', '#484848');
