...
$string['cocoon_course_categories:addinstance'] = 'Add a new courses block';
$string['cocoon_course_categories:myaddinstance'] = 'Add a new courses block to Dashboard';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = '[Cocoon] Course categories';
