...
//This is additional resources button for another course which is inbuild in this courses
        ...
        //  echo $ajaxcontrol;
            ...
            {
                echo "<a href='$CFG->wwwroot/course/view_resources.php?id=$resource_id->resourcecourseid' style='text-transform: uppercase; display:none; width:fit-content; margin: 0% auto;'>View More and Add Resources</a>";
            }
            else
            {
