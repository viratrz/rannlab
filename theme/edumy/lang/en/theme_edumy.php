...
$string['config_color_course_card'] = 'Unit card';
$string['config_color_course_title'] = 'Unit title';
$string['config_color_course_price'] = 'Unit price';
$string['config_color_course_enrol_btn'] = 'Unit enrol button';
...
$string['number_of_courses'] ='Over {$a} units';
$string['number_of_subcategories'] ='Over {$a} categories';
$string['categories'] = 'Categories';
$string['hidden'] ='Hidden';
$string['back_to_course'] ='Back to Unit';
$string['back_to_site'] ='Back to Site';
$string['course_navigation'] ='Unit Navigation';
...
$string['courseliststyle'] = 'Unit list style';
$string['courseliststyle_desc'] = 'The style for the unit category view.';
...
$string['library_list_desc'] = 'Display a library list (list of unit categories) in the header.';
...
$string['disable_primary_nav_desc'] = 'Disable Moodle core primary navigation? This will remove "Home", "Dashboard", "My Units", and "Site administration" links from the main menu bar.';
...
$string['course_content_enroled_only'] = 'Unit Content access';
$string['course_content_enroled_only_desc'] = '(Topics format only) - Choose whether to display unit content to all users, or only those enroled in the unit. This is helpful you want to allow guest access to unit pages, but hide the list of unit content, topics, sections, and activity names from unenroled users.';
...
$string['coursecat_modified_desc'] = 'Show the date that the unit/category was last updated.';
$string['coursecat_enrolments'] = 'Unit enrolments';
$string['coursecat_enrolments_desc'] = 'Show the number of students enroled in a unit.';
$string['coursecat_announcements'] = 'Unit news items';
$string['coursecat_announcements_desc'] = 'Show the number of unit announcements in a unit.';
$string['coursecat_prices'] = 'Unit price';
$string['coursecat_prices_desc'] = 'Show unit prices in category lists and blocks.';
$string['coursecat_settings'] = 'Unit category settings';
$string['single_course_settings'] = 'Single unit settings';
$string['course_single_style'] = 'Single unit style';
$string['course_single_style_desc'] = 'Select the style to use on single units.';
$string['course_start_date'] = 'Unit start date';
$string['course_start_date_desc'] = 'Display the start date in single unit pages, above the unit content.';
$string['course_category'] = 'Unit category';
$string['course_category_desc'] = 'Display the category in single unit pages, above the unit content.';
$string['seo'] = 'SEO';
...
$string['incourse_layout'] = 'In unit layout';
$string['incourse_layout_desc'] = 'The layout that should be used when a user is within a unit (eg accessing individual unit activities, resources, or content). Custom blocks may not be displayed when using the Dashboard layout.';
$string['coursemainpage_layout'] = 'Unit main page layout';
$string['coursemainpage_layout_desc'] = 'The layout that should be used when a user is on a unit main page. Custom blocks may not be displayed when using the Dashboard layout.';
$string['singlecourse_blocks'] = 'Unit block visibility';
$string['singlecourse_blocks_desc'] = 'Choose whether to display blocks added to units on all pages of the unit, or only on the main unit page. Use this setting to prevent blocks from appearing on similar unit pages (such as the Participants page and User pages). This setting affects all blocks added to units, not just Cocoon blocks.';
...
$string['course_enrolment_payment'] = 'Unit enrolment payment';
$string['course_enrolment_payment_desc'] = 'Settings for unit enrolment preferences. Do all units require payment, or are some free? This setting dictates how course enrolment will work and be displayed.';
...
$string['general_course_settings'] = 'General unit settings';
$string['course_ratings'] = 'Unit ratings';
$string['course_ratings_desc'] = 'Settings for unit star ratings.';
...
$string['coursesiamteaching'] = 'Units I\'m teaching';
$string['coursesiamtaking'] = 'Unit I\'m taking';
...
$string['last_accessed_courses'] = 'Last Accessed Units';
...
$string['search_courses'] = 'Search units...';
...
$string['course_buy_access'] = 'Paid unit entry';
$string['course_enrolled'] = 'You\'re enrolled';
$string['course_enrolled_text'] = 'You are currently enrolled in this unit.';
$string['course_enrolled_teacher'] = 'You\'re teaching';
$string['course_enrolled_teacher_text'] = 'You are currently teaching this unit.';
$string['course_error_title'] = 'Enrolment Error';
$string['course_error_text'] = 'Your administrator has not yet configured PayPal or Stripe Enrolment for this unit.';
...
$string['total'] = 'Total';
$string['total_courses'] = 'Units';
$string['price'] = 'Price';
$string['course_id'] = 'Unit ID';
...
$string['preview_course'] = 'Preview Unit';
$string['library'] = 'Library';
$string['have_an_account'] = 'Have an account?';
$string['course_content'] = 'Unit Content';
...
$string['no_courses_yet'] = 'No units yet';
